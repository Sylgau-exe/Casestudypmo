-- NovaTech Robotics PMO Demo Data
-- YCBS 288 - Strategic Project Leadership
-- Run this in your Neon console AFTER schema.sql

UPDATE pmo_state SET 
projects = '[
    {
        "id":"ip1",
...
triage_items = '[]'::jsonb,
criteria_weights = '{"strategic_fit":25,"productivity":20,"market":15,"core_competency":15,"feasibility":15,"mission":10}'::jsonb,
updated_at = NOW(),
updated_by = 'System - NovaTech Demo Data'
